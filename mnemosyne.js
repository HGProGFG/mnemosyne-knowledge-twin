const seedDocuments=[
 {id:"system-design",name:"System Design Notes.md",createdAt:"2026-07-06T09:00:00Z",chunks:[
 ...
 {id:"learning-journal",name:"ML Learning Journal.md",createdAt:"2026-07-04T09:00:00Z",chunks:[
 ...
 {id:"project-retro",name:"Q2 Project Retrospective.md",createdAt:"2026-07-02T09:00:00Z",chunks:[
...
function rankEvidence(question){
 const query=tokens(question);const chunks=documents.flatMap(documentRecord=>documentRecord.chunks.map((content,position)=>({documentId:documentRecord.id,name:documentRecord.name,content,position})));
...
async function handleFile(file){
 ...
 const documentRecord={id:crypto.randomUUID(),name:file.name,createdAt:new Date().toISOString(),chunks};
